...
class TargetAmountCard extends StatefulWidget {
  final Function({
    required int age,
  ...
  @override
  State<TargetAmountCard> createState() => _TargetAmountCardState();
}

class _TargetAmountCardState extends State<TargetAmountCard> {
  int _age = 25;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Define cuánto quieres retirar al final',
                      style: TextStyle(
                        fontSize: 14,
          ...
          // Campo de edad objetivo
          _buildField(
            label: 'Edad Objetivo',
            value: '$_targetAge años',
            onTap: () => _showTargetAgeSelector(),
          ),
          const SizedBox(height: 24),

          // Campo de monto objetivo
          _buildAmountField(),
          const SizedBox(height: 32),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            hintText: 'Ingresa el monto deseado',
  ...
  void _showAgeSelector() {
    showModalBottomSheet(
      ...
      builder: (context) => _buildSelector(
        title: 'Selecciona tu edad actual',
  ...
  void _showTargetAgeSelector() {
    final availableAges = SavingsConstants.ages.where((age) => age > _age).toList();
    showModalBottomSheet(
      context: context,
      builder: (context) => _buildSelector(
        title: 'Selecciona la edad objetivo',
        items: availableAges,
        currentValue: _targetAge,
        onSelected: (value) => setState(() => _targetAge = value),
        formatter: (value) => '$value años',
      ),
    );
  }
  ...
  void _validateAndSimulate() {
    ...
    if (_targetAge <= _age) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('La edad objetivo debe ser mayor a la edad actual'),
          backgroundColor: Colors.red,
        ),
      );
      return;
