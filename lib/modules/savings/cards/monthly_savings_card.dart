...
class MonthlySavingsCard extends StatefulWidget {
  final Function({
    required int age,
  ...
  const MonthlySavingsCard({
    ...
    this.initialAge,
    this.initialPlanDuration,
    this.initialMonthlySavings,
  });

  @override
  State<MonthlySavingsCard> createState() => _MonthlySavingsCardState();
}

class _MonthlySavingsCardState extends State<MonthlySavingsCard> {
  int _age = 25;
  int _planDuration = 10;
  ...
  void initState() {
    ...
    if (widget.initialPlanDuration != null) _planDuration = widget.initialPlanDuration!;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Campo de duración del plan
          _buildField(
            label: 'Duración del Plan',
            value: '$_planDuration años',
            onTap: () => _showPlanDurationSelector(),
          ),
          const SizedBox(height: 24),
  ...
  void _showPlanDurationSelector() {
    showModalBottomSheet(
      context: context,
      builder: (context) => _buildSelector(
        title: 'Selecciona la duración del plan',
        items: SavingsConstants.planDurations,
        currentValue: _planDuration,
        onSelected: (value) => setState(() => _planDuration = value),
        formatter: (value) => '$value años',
      ),
    );
  }
